...
% - Should we cite more in the regularized and compressed-sensing contexts?
% - Should we be more explicit about what goes wrong at high dimensions?
% - Be careful to make it make it clear that we consider cross-validation to be the only empirical method to understand overfitting; check the words we write about over-fitting to match. It isn't just about the number of parameters.
