...
This process is illustrated in \figurename~\ref{fig:LOO1}, where we show $23$ fits, each of which is trained to the 22 points left when we leave one of the $n=23$ points out.
...
The uncertainty coming from (3)~uncertainties in the locations $t_i$, and (4)~model choices are much harder to model and propagate.
